              ...
              <div class="col-lg">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class="h4 text-gray-900 mb-4">Pengaduan diajukan pada Tanggal <span class="text-info"><?php echo $datap['tgl_pengaduan'];?></span> [ID:<?php echo $datap['id_pengaduan'];?>]</h2>
                  </div>
                  <form method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <input value="<?php echo $datap['telp'];?>" required="required" type="text" class="form-control form-control-user" id="exampleInputEmail" readonly="readonly" aria-describedby="emailHelp">
                    </div>

                    <div class="form-group">
                      <label>Type Laporan</label>
                      <input value="<?php echo $datap['type'];?>" type="text" readonly="readonly" name="" required="required" class="form-control form-control-user" id="exampleInputEmail"  placeholder="Link">
                    </div>

                    <div class="form-group">
                      <label>OPD</label>
                      <input value="<?php echo $datap['opd'];?>" type="text" readonly="readonly" name="" required="required" class="form-control form-control-user" id="exampleInputEmail" >
                    </div>

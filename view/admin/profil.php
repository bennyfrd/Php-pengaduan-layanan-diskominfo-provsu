                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="">
                    <div class="form-group">
                      ...
                      <input required="required" type="text" name="nama_petugas" class="form-control" id="exampleInputEmail" value="<?= $sql['nama_petugas'];?>" aria-describedby="emailHelp" placeholder="Nama Petugas">
                    </div>
                    <div class="form-group">
                      <small>Nomor Telepon</small>
                      <input required="required" type="number" name="telp" class="form-control" id="exampleInputPassword" value="<?= $sql['telp'];?>" placeholder="Nomor Telepon">
                    </div>
<?php
if(isset($_GET['berhasil'])){
  if($_GET['berhasil']=="keynotvalid"){
...
?>  
                    ...
                    <center>
                    <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#konfirmasi">Simpan</a>  
                    </center>
